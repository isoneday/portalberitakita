...
public class PlaynewsActivity extends AppCompatActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    int[] photos={R.drawable.pho1, R.drawable.pho2,R.drawable.pho3,R.drawable.pho4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAlphaForegroundColorSpan = new AlphaForegroundColorSpan(0xFFFF00FF);
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = { "Top headlines", "Everything"};
        ...
        public Fragment getItem(int position) {
            ScrollTabHolderFragment fragment = (ScrollTabHolderFragment) BeritaScrollViewFragment.newInstance(position);
