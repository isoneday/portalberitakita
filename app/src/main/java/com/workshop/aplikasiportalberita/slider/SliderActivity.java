package com.workshop.aplikasiportalberita.slider;
...
import com.workshop.aplikasiportalberita.PlaynewsActivity;
import com.workshop.aplikasiportalberita.R;
import com.workshop.aplikasiportalberita.portalberita.helper.PrefManager;
...
public class SliderActivity extends AppCompatActivity {
    ...
    private static PrefManager prefManager1;
    ...
    private static SliderActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!prefManager.isFirstTimeLaunch()) {
            launchHomeScreen(SliderActivity.this);
            finish();
        }
    ...
    private static void launchHomeScreen(FragmentActivity activity1) {
        prefManager1 = new PrefManager(activity1);
        prefManager1.setFirstTimeLaunch(false);
        activity1.startActivity(new Intent(activity1,PlaynewsActivity.class));
        activity1.finish();
    }
    ...
    private static void animateSecondScreen(float position, int pageWidth, int direction) {
    ...
    public static class ScreenSlideFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (position == 2) {
                ...
                initThirdScreenViews(getActivity(),rootView, savedInstanceState);
            }
    ...
    private static void initSecondScreenViews(View rootView, Bundle savedInstanceState) {
    ...
    private static void initThirdScreenViews(final FragmentActivity activity1, View rootView, Bundle savedInstanceState) {

        mRoundView = (ThirdScreenView) rootView.findViewById(R.id.round_view);
        mLetsGoButton = (Button) rootView.findViewById(R.id.letsgo);
        SliderActivity.activity = new SliderActivity();
       // mLetsGoButton.setOnClickListener(clickListener);
        mLetsGoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                launchHomeScreen(activity1);
            }
        });
        mRoundView.setContext(SliderActivity.activity);

    }

    static View.OnClickListener clickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.letsgo:
                   ...
                   // function.pindahclass(TestAja.class);
